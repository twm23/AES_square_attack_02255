...
#function that does a byte look-up of the s-box
def lookup(byte):
    #x equals the 4 most significant bits
    x = byte >> 4
    #y equals the 4 least significant bits
    y = byte & 15
    return aes_sbox[x][y]

#function that does a byte look-up of the reverse s-box
